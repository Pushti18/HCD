   ...
   //   }
     ...
     if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
         ...
         exit;
           ...
           $internship = "INSERT INTO research (enroll,studentName,name_of_award,date,year,team,level,name_of_agency,contact_details,remarks,photo_of_award,receiving_award) 
           ...
           if (mysqli_query($conn, $internship)) {
               ...
               $id = "SELECT id FROM research WHERE enroll = '$user_id'  ";
               $id_res = $conn->query($id);
   
               $row = mysqli_fetch_array($id_res,MYSQLI_ASSOC);
   
               
               header ("Location: demoadmin_research.php");
