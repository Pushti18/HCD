...
<html>
   ...
   <body>
      ...
      <div class="container">
         <h1>Mooc</h1>
         <a href="moocdata.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add new Mooc Details</button></a><br><br>
         <?php 
                  ...
                  <td>
                     <?php 
                        if ($_SESSION['enrollment_no']== $row['enroll']) {
                          ...
                          echo '<a href="updatemooc.php"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i>Update</a>';
                        } else {
                          echo "";
