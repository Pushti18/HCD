         ...
         <tr>
            ...
            <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                     <li><a tabindex="-1" href="demoadmin.php">Intenship</a></li>
                     <li><a tabindex="-1" href="demoadmin_mooc.php">MOOC</a></li>
                     <li class="dropdown-submenu">
                        <a class="test" tabindex="-1" href="#">Co Curricular<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                           <li><a tabindex="-1" href="demoadmin_research.php">Research/Innovation</a></li>
                           <li><a tabindex="-1" href="demoadmin_technical.php">Technical Activities</a></li>
                        </ul>
                     </li>
                     <li class="dropdown-submenu">
                        <a class="test" tabindex="-1" href="#">Extra Curricular<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                           <li><a tabindex="-1" href="demoadmin_sports.php">Sports/Cultural</a></li>
                           <li><a tabindex="-1" href="demoadmin_extension.php">Extension Activities</a></li>
                        </ul>
                     </li>
                  </ul>
               </div>
               <!-- <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                     <a href="demoadmin.php">Intenship</a>
                     <a href="demoadmin_mooc.php">MOOC</a>
                     <a href="#">Awards/Achievements</a>
                     <a href="">Extra Curriculum</a>
                     <a href="demoadmin_sports.php">Sports/Cultural</a>
                     <a href="demoadmin_extension.php">Extension Activities</a>
                     <a href="">Co Curriculum</a>
                     <a href="demoadmin_research.php">Research/Innovation</a>
                     <a href="demoadmin_technical.php">Technical Activities</a>
                  </div>
                  </button>
               </div> -->
            </th>
