...
<html>
   ...
   <body>
      ...
      <div class="container">
         <h1>Extension</h1>
         <a href="admin_insertdata_extension.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add Extension Achievements</button></a><br><br>
         <?php 
