...
<html>
   ...
   <body>
      ...
      <div class="container">
         ...
         <form action="code_technical.php" method="POST" rowspan="10" colspan="10"  style="width: 100px;">
         ...
         <!-- <a href="sportsdata.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add Sports Achievements</button></a><br><br>
            <?php 
               $enroll = $_SESSION["enrollment_no"];
                 $sql = "SELECT * from technical  where enroll='$enroll'";
         ...
         <!-- Table start -->
         <table class="tablemanager"  id="example" align="center" style="width:100%">
            <thead>
               <tr>
