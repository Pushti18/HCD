...
<body>
 <br><br><br>
    ...
    <table align="center" >
	<form method="post" action="inernshipconn.php" enctype="multipart/form-data"  >
    <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<input type="submit" value="submit"  name= "submit" style="float:center!important;display:inline;">
</table>
</form>
