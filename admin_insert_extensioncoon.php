   ...
   //   }
     ...
     if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
         ...
         exit;
           ...
           $internship = "INSERT INTO extension (enroll,studentName,name_of_award,date,year,team,level,name_of_agency,contact_details,photo_of_award,receiving_award) 
           ...
           if (mysqli_query($conn, $internship)) {
               ...
               header ("Location: demoadmin_extension.php");
