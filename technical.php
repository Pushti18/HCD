...
<html>
   ...
   <body>
      ...
      <div class="container">
         ...
         <a href="technicaldata.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add Technical Activities</button></a><br><br>
         <?php 
                  ...
                  <td>
                     <?php 
                        if ($_SESSION['enrollment_no']== $row['enroll']) {
                          ...
                          echo '<a href="technical_update.php"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i>Update</a>';
                        } else {
                          echo "";
