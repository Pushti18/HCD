...
<html>
   ...
   <body>
      ...
      <div class="container">
         ...
         <a href="researchdata.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add Research/Innovation Achievements</button></a><br><br>
         <?php 
            $enroll = $_SESSION["enrollment_no"];
              $sql = "SELECT * from research  where enroll='$enroll'";
                  ...
                  <td>
                     <?php 
                        if ($_SESSION['enrollment_no']== $row['enroll']) {
                          ...
                          echo '<a href="research_update.php"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i>Update</a>';
                        } else {
                          echo "";
