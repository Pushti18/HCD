...
<html>
   ...
   <body>
      ...
      <div class="container">
         <h1>Extension</h1>
         <a href="extensiondata.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add Extension Achievements</button></a><br><br>
         <?php 
            $enroll = $_SESSION["enrollment_no"];
              $sql = "SELECT * from extension  where enroll='$enroll'";
                  ...
                  <td>
                     <?php 
                        if ($_SESSION['enrollment_no']== $row['enroll']) {
                          ...
                          echo '<a href="extension_update.php"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i>Update</a>';
                        } else {
                          echo "";
