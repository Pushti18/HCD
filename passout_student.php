            ...
            <tbody>
               ...
               <tr >
                  ...
                  <td>
                     ...
                     <!-- </tr> -->
                     <!-- </form> -->
                     <form action="admin_selectoption.php" method="post">
                        <input type="hidden" name="std_en" value="<?php echo $row['rollno'];?>">
                        <?php $_SESSION['std_en_no'] = $row['rollno'];?>
