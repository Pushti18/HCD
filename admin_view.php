...
<html>
   ...
   <body>
      ...
      <div class="container">
         <h1>Admin Internship Details</h1>
         <form action="code.php" method="POST" rowspan="10" colspan="10"  style="width: 100px;">
         ...
         <a href="passout_student.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Student Login</button></a><br><br>
         <!-- <?php 
         ...
         <table class="tablemanager"  id="example" align="center" >
            <thead>
               <tr>
                  ...
                  <th  class="disableFilterBy disableSort" style="width: 20%">REFERENCE</th>
