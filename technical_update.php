...
<html>
   <head>
      <title>Technical Activities</title>
   ...
   <body>
      ...
      <table align="center" >
         <form method="post" action="technical_update_conn.php" enctype="multipart/form-data"  >
            <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
            ...
            <tr>
               <h2 align="center">Technical Activities</h2>
            <tr>
               <?php
                  $sql = "SELECT * from technical where enroll='$user_id'";
            ...
            <tr>
               <td>
                  <label for="name" ><i class="fa fa-check-square" aria-hidden="true">&nbsp; &nbsp;Remarks:</i></label>
               </td>
               <td>
                  <input type="text" id="remarks" name="remarks" value="<?php echo $row['remarks']?>"><br><br>
               </td>
            </tr>
            <tr>
               <td>
                  <label for="file"><i class="fa fa-upload " aria-hidden="true">&nbsp;&nbsp;&nbsp;Photo of Award:</i></label><br>
               </td>
               <td>
            ...
            <tr>
               <td>
                  <label for="file"><i class="fa fa-cloud-upload " aria-hidden="true">&nbsp;&nbsp;&nbsp;Receving Photo of Award:</i></label><br>
               </td>
               <td>
                  <!-- <label for="file">Certificate:</label> -->
