...
<html>
   ...
   <body>
      ...
      <div class="container">
         ...
         <a href="try.php"><button type="button" class="btn btn-success btn-rounded" style="float: right;">Add new Internship Report</button></a><br><br>
         <?php 
            $enroll = $_SESSION["enrollment_no"];
              $sql = "SELECT * from intenship  where enroll='$enroll'";
            
              
              $result = mysqli_query($conn, $sql);
              $row = mysqli_fetch_assoc($result);
            ?>
         <a href="./Report/admin.php?enroll=<?php echo $row['enroll'].'&noc='.$row['name_of_company'].'&id='.$row['id']; ?>" name="report">
         <button type="button" class="btn btn-danger btn-rounded" style="float: right;">Your Internship Report</button></a>
         ...
         <table class="tablemanager"  id="example" align="center" >
            <thead>
               <tr>
                  ...
                  <th class="disableFilterBy">SKILLS INVOLVED</th>
                  <th  class="disableSort disableFilterBy" style="width: 20%">REFERENCE</th>
                  <!-- <th  class="disableFilterBy">PHOTOS</th>
                     <th  class="disableFilterBy">CERTIFICATE</th>
                     <th  class="disableFilterBy">REPORT</th> -->
                  <th class="disableFilterBy" >UPDATE</th>
               </tr>
            </thead>
            <tbody>
               <?php 
               ...
               <tr >
                  ...
                  <td>
                     <?php 
                        echo $row['Type_of_Intenship'];
                        ?><br>
                  </td>
                  <td>
                     <?php 
                        echo $row['Skills_Involved'];
                        ?><br>
                  </td>
                  <td>
                     <a href="<?php echo $row['Reference']; ?>" target="_blank">View - Reference</a>
                     <!-- </td> -->
                     <br>
                     <!-- <td> -->
                     <a href="<?php echo $row['Photos']; ?>" target="_blank">View - Photos</a>
                     <!-- </td> -->
                     <br>
                     <!-- <td> -->
                     ...
                     <br>
                     <!-- <td> -->
                     <a href="<?php echo $row['Report']; ?>" target="_blank">View - Report</a>
                  </td>
                  <br>
                  <td>
                     ...
                     <?php 
                        if ($_SESSION['enrollment_no']== $row['enroll']) {
                          ...
                          echo '<a href="update.php"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i>Update</a>';
                        } else {
                          echo "";
